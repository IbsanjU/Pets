 ...
 */
public
class PetProvider extends ContentProvider {
    /**
     ...
     */
    private
    Uri insertPet(Uri uri, ContentValues values) {
    ...
    @Override
    public
    int update(Uri uri, ContentValues contentValues, String selection, String[] selectionArgs) {
        return 0;
    }
